...
<div class="iCMS-container">
  <div class="widget-box">
    <div class="widget-title"> <span class="icon"> <i class="fa fa-list"></i> </span>
      <h5>后台菜单</h5>
      <div id="treecontrol"> <a style="display:none;"></a> <a style="display:none;"></a> <a class="btn btn-mini btn-info" href="javascript:;">Развернуть / Свернуть</a></div>
      <a style="margin: 10px;" class="btn btn-mini" href="<?php echo __ADMINCP__; ?>=cache&do=menu" target="iPHP_FRAME"><i class="fa fa-refresh"></i>Обновить кэш</a>
    </div>
