...
//        }
    ...
    public function do_cache(){
        $this->cache();
        iUI::success('Обновление кэша завершено!','js:1');
    }
    ...
    public static function btn_group($field,$target = null, $app = null){
        ...
        $div.= '<a class="btn dropdown-toggle" data-toggle="dropdown" tabindex="-1"> <span class="caret"></span> Выбрать</a>';
        ...
        $div.= '<li>';
        $div.= self::btn_add('Добавить общие свойства',$field,$app,null);
        // $div.= '<a class="btn tip-right" href="'.__ADMINCP__.'=prop&do=add&_app='.$app.'&field='.$field.'" target="_blank" title="Добавить общие свойства"><i class="fa fa-plus"></i>常用属性</a>';
        $div.= '</li></ul>';
        $div.= '</div>';
        return $div;
    }
