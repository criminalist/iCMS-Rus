...
configAdmincp::head("Настройки пользователя");
?>
...
<div class="clearfloat mb10"></div>
<div class="input-prepend">
    <span class="add-on">Обложка по умолчанию</span>
    <input type="text" name="config[coverpic]" class="span4" id="user_coverpic" value="<?php echo $config['coverpic'] ; ?>"/>
</div>
<span class="help-inline">Пожалуйста, поместите изображение в каталог public</span>
<div class="clearfloat mb10"></div>
<hr />
<h3 class="title">WeChat открытая платформа</h3>
...
<span class="help-inline">Пример:https://www.icmsdev.com</span>
<hr />
