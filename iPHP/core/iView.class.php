...
class iView {
    ...
    public static function Template() {
        ...
        $tpl->error_reporting_header    = "<?php defined('iPHP') OR exit('Oops, something went wrong');error_reporting(iPHP_TPL_DEBUG?E_ALL & ~E_NOTICE:0);?>\n";
        $tpl->left_delimiter  = '<!--{';
        $tpl->right_delimiter = '}-->';
        ...
        $tpl->register_modifier("translit",array("iTranslit", "get"));
    ...
    public static function callback_compile($content,$file,$obj){
        return str_replace("<?php defined('iPHP') OR exit('Oops, something went wrong');?>", '', $content);
    }
    /**
     * 模板路径
