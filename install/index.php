...
//框架初始化
require iPATH.'iPHP/iPHP.php';			//каркасный файл iPHP
		...
		<div class="container">
			...
			<div class="well hide step" id="step4">
				...
				<form class="form-horizontal" action="install.php" method="post" id="install_form" target="iCMS_FRAME">
					...
					<h2>设置超级管理员</h2>
					<div class="control-group">
						<label class="control-label" for="ADMIN_NAME">Аккаунт</label>
						<div class="controls">
							<input type="text" id="ADMIN_NAME" name="ADMIN_NAME" placeholder="管理员账号">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="ADMIN_PASSWORD"> Пароль </label>
						<div class="controls">
