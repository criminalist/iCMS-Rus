...
define('iPHP',TRUE);
define('iPHP_APP','iCMS'); //Название приложения
...
if($_POST['action']=='install'){
	...
	define('iPHP_DB_HOST',$db_host);	//Имя сервера или ip сервера, зачастую по умолчанию localhost
    define('iPHP_DB_PORT', $db_port);   //Порт базы данных
	define('iPHP_DB_USER',$db_user);		//Имя пользователя базы
	define('iPHP_DB_PASSWORD',$db_password);//Пароль к базе
	define('iPHP_DB_NAME',$db_name);		//Имя базы данных
    define('iPHP_DB_PREFIX',$db_prefix);    //Префикс
...
//配置程序
    ...
    configAdmincp::cache();
    del_patch_files();
//Конфигурация подключения к базе данных<hr />开始安装数据库<hr />数据库安装完成<hr />设置超级管理员<hr />更新网站缓存<hr />
