    ...
    return {
        ...
        favorite: function(a,callback) {
            ...
            var dialog = UI.dialog({
                title: $box.data("title")||'Добавили в избранное',content:$wrap,
            ...
            $('.create,.cancel_create', $wrap).click(function(event) {
                ...
                if($(this).hasClass('create')){
                    dialog.title($box.data("create-title")||"Создать новую коллекцию");
                }else{
                    dialog.title($box.data("title")||"Добавили в избранное");
                }
            ...
            $('[name="create"]', $wrap).click(function(event){
                ...
                if(data.title==""){
                    ...
                    $('.favorite_create_error',$wrap).text('Введите название').show();
                    return false;
                }
